...
public class RoundedCornerImageFromWebActivity extends Activity
{
	final static String TAG = "RoundedCornerImageFromWebActivity";
	...
	public void onCreate(Bundle savedInstanceState) 
	{
        ...
        setContentView(R.layout.activity_roundedcornerimagefromweb);
        
        myImageView = (ImageView) findViewById(R.id.imageViewRoundedCornerImageFromWeb);
        spinner = (ProgressBar) findViewById(R.id.progressBarRoundedCornerImageFromWeb);
